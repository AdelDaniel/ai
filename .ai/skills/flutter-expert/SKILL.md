---
name: flutter-expert
description: "Master Flutter development with Dart 3, advanced widgets, multi-platform deployment, state management, animations, testing, and performance optimization."
metadata:
  model: inherit
risk: unknown
source: community
...
- If detailed examples are required, inspect the relevant `.ai/skills/` or `.ai/instructions/` resource first.
